...
// end include: preamble.js
  ...
  allocateUnusedWorker() {
        ...
        var pthreadMainJs = locateFile('fractal.worker.js');
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(3, 1, fd, iov, iovcnt, pnum);
...
var _render_julia_double = Module['_render_julia_double'] = createExportWrapper('render_julia_double');
var _render_mandelbrot_double = Module['_render_mandelbrot_double'] = createExportWrapper('render_mandelbrot_double');
